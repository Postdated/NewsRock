...
return array(
    ...
    'Newspack_Multibranded_Site\\Admin' => $baseDir . '/includes/class-admin.php',
    'Newspack_Multibranded_Site\\Admin\\Cat_Primary_Brand' => $baseDir . '/includes/admin/class-cat-primary-brand.php',
    'Newspack_Multibranded_Site\\Admin\\Filter_Posts' => $baseDir . '/includes/admin/class-filter-posts.php',
    'Newspack_Multibranded_Site\\Admin\\Post_Primary_Brand' => $baseDir . '/includes/admin/class-post-primary-brand.php',
    'Newspack_Multibranded_Site\\Admin\\Prompt_Popups' => $baseDir . '/includes/admin/class-prompt-popups.php',
    'Newspack_Multibranded_Site\\Admin\\Show_Page_On_Front' => $baseDir . '/includes/admin/class-show-page-on-front.php',
    'Newspack_Multibranded_Site\\Admin\\User_Primary_Brand' => $baseDir . '/includes/admin/class-user-primary-brand.php',
    'Newspack_Multibranded_Site\\Customizations\\Blogname' => $baseDir . '/includes/customizations/class-blogname.php',
    'Newspack_Multibranded_Site\\Customizations\\Body_Class' => $baseDir . '/includes/customizations/class-body-class.php',
    'Newspack_Multibranded_Site\\Customizations\\Logo' => $baseDir . '/includes/customizations/class-logo.php',
    'Newspack_Multibranded_Site\\Customizations\\Menus' => $baseDir . '/includes/customizations/class-menus.php',
    'Newspack_Multibranded_Site\\Customizations\\Popups_Should_Display_Prompt' => $baseDir . '/includes/customizations/class-popups-should-display-prompt.php',
    'Newspack_Multibranded_Site\\Customizations\\Show_Page_On_Front' => $baseDir . '/includes/customizations/class-show-page-on-front.php',
    'Newspack_Multibranded_Site\\Customizations\\Site_Title' => $baseDir . '/includes/customizations/class-site-title.php',
    'Newspack_Multibranded_Site\\Customizations\\Theme_Colors' => $baseDir . '/includes/customizations/class-theme-colors.php',
    'Newspack_Multibranded_Site\\Customizations\\Url' => $baseDir . '/includes/customizations/class-url.php',
    'Newspack_Multibranded_Site\\Initializer' => $baseDir . '/includes/class-initializer.php',
    'Newspack_Multibranded_Site\\Integrations\\Access_Control' => $baseDir . '/includes/integrations/class-access-control.php',
    'Newspack_Multibranded_Site\\Integrations\\Google_Analytics' => $baseDir . '/includes/integrations/class-google-analytics.php',
    'Newspack_Multibranded_Site\\Meta' => $baseDir . '/includes/class-meta.php',
    'Newspack_Multibranded_Site\\Meta\\Category_Primary_Brand' => $baseDir . '/includes/meta/class-category-primary-brand.php',
    'Newspack_Multibranded_Site\\Meta\\Logo' => $baseDir . '/includes/meta/class-logo.php',
    'Newspack_Multibranded_Site\\Meta\\Menus' => $baseDir . '/includes/meta/class-menus.php',
    'Newspack_Multibranded_Site\\Meta\\Post_Primary_Brand' => $baseDir . '/includes/meta/class-post-primary-brand.php',
    'Newspack_Multibranded_Site\\Meta\\Show_Page_On_Front' => $baseDir . '/includes/meta/class-show-page-on-front.php',
    'Newspack_Multibranded_Site\\Meta\\Tag_Primary_Brand' => $baseDir . '/includes/meta/class-tag-primary-brand.php',
    'Newspack_Multibranded_Site\\Meta\\Theme_Colors' => $baseDir . '/includes/meta/class-theme-colors.php',
    'Newspack_Multibranded_Site\\Meta\\Url' => $baseDir . '/includes/meta/class-url.php',
    'Newspack_Multibranded_Site\\Meta\\User_Primary_Brand' => $baseDir . '/includes/meta/class-user-primary-brand.php',
    'Newspack_Multibranded_Site\\Taxonomy' => $baseDir . '/includes/class-taxonomy.php',
